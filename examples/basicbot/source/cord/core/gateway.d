...
import cord.http.client;
import cord.core.packets;
import cord.models;
import cord.core.opcodes;
...
{
    import cord.client;
    import cord.logging.logger : infoLog, warnLog, errorLog;
    import cord.endpoints : Endpoints;
